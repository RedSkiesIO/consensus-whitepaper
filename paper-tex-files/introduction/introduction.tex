...
\item \textbf{Chapter \ref{Cha:Sha} - Scaling Catalyst}: this chapter describes how sharding techniques are implemented on the Catalyst network, how the ledger is partitioned and the consensus mechanism adapted to function on a shard ledger. 
